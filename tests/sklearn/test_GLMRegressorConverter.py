...
class TestGLMRegressorConverter(unittest.TestCase):
    ...
    def test_model_linear_regression(self):
        ...
        dump_data_and_model(X.astype(numpy.float32), model, model_onnx, basename="LinearRegression-Dec4")
    ...
    def test_model_linear_svr(self):
        ...
        self.assertIsNotNone(model_onnx)
        dump_data_and_model(X.astype(numpy.float32), model, model_onnx, basename="LinearSvr-Dec4")
    ...
    def test_model_ridge(self):
        ...
        self.assertIsNotNone(model_onnx)
        dump_data_and_model(X.astype(numpy.float32), model, model_onnx, basename="Ridge-Dec4")
    ...
    def test_model_sgd_regressor(self):
        ...
        self.assertIsNotNone(model_onnx)
        dump_data_and_model(X.astype(numpy.float32), model, model_onnx, basename="SGDRegressor-Dec4")
    ...
    def test_model_elastic_net_regressor(self):
        ...
        self.assertIsNotNone(model_onnx)
        dump_data_and_model(X.astype(numpy.float32), model, model_onnx, basename="ElasticNet-Dec4")
    ...
    def test_model_lasso_lars(self):
        ...
        self.assertIsNotNone(model_onnx)
        dump_data_and_model(X.astype(numpy.float32), model, model_onnx, basename="LassoLars-Dec4")
