...
def convert_model(model, name, input_types, onnx_operators_only=False):
    """
    ...
    if model.__class__.__name__.startswith("LGBM"):
        ...
        model, prefix = convert_lightgbm(model, name, input_types, onnx_operators_only=onnx_operators_only), "LightGbm"
