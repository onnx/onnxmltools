...
register_shape_calculator('SklearnKNeighborsRegressor', calculate_sklearn_linear_regressor_output_shapes)
register_shape_calculator('SklearnLassoLars', calculate_sklearn_linear_regressor_output_shapes)
register_shape_calculator('SklearnRidge', calculate_sklearn_linear_regressor_output_shapes)
