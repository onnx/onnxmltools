...
def convert_pca_and_truncated_svd(scope, operator, container):
    ...
    transform_matrix = raw_op.components_.transpose()
...
register_converter('SklearnPCA', convert_pca_and_truncated_svd)
register_converter('SklearnTruncatedSVD', convert_pca_and_truncated_svd)
