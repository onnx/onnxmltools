...
class AverageLayerConverter:

    @staticmethod
    def validate(cm_node):
        try:
            utils._check_has_attr(cm_node, 'average')
...
registration.register_nn_converter('average', AverageLayerConverter)
