...
class MultiplyLayerConverter:

    @staticmethod
    def validate(cm_node):
        try:
            utils._check_has_attr(cm_node, 'multiply')
...
registration.register_nn_converter('multiply', MultiplyLayerConverter)
