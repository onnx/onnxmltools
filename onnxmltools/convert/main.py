...
def convert_sklearn(model, name=None, initial_types=None, doc_string='', targeted_onnx=onnx.__version__, custom_conversion={}):
    ...
    return convert(model, name=name, initial_types=initial_types,
                   doc_string=doc_string, targeted_onnx=targeted_onnx, custom_conversion=custom_conversion)


def convert_coreml(model, name=None, initial_types=None, doc_string='', targeted_onnx=onnx.__version__ , custom_conversion={}):
...
def convert_keras(model, name=None, initial_types=None, doc_string='', targeted_onnx=onnx.__version__, custom_conversion={}):
