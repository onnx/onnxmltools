...
def convert_sklearn(model, name=None, initial_types=None, doc_string='', targeted_onnx=onnx.__version__, custom_conversions={}):
    ...
    return convert(model, name=name, initial_types=initial_types,
                   doc_string=doc_string, targeted_onnx=targeted_onnx, custom_conversions=custom_conversions)


def convert_coreml(model, name=None, initial_types=None, doc_string='', targeted_onnx=onnx.__version__ , custom_conversions={}):
...
def convert_keras(model, name=None, initial_types=None, doc_string='', targeted_onnx=onnx.__version__, custom_conversions={}):
    ...
    return convert(model, name, initial_types=initial_types,
                   doc_string=doc_string, targeted_onnx=targeted_onnx, custom_conversions=custom_conversions)
