...
# we can conduct quick fixes by overwriting ONNX
# functions without changing any lines elsewhere.
from onnx import onnx_pb as onnx_proto  # noqa

# Overwrite the make_tensor defined in onnx.helper because
# of a bug (string tensor get assigned twice)
